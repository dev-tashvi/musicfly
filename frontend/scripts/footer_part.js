async function Footer(){
    ...
    <div id="footContainer">
        <div id="divRow1">
            <strong>MusicFly</strong>
            <p>MusicFly is the one-stop solution for all your music needs. MusicFly offers you free, unlimited access to over 30 million Hindi Songs, Bollywood Music, English MP3 songs, Regional Music & Mirchi Play.</p>
        </div>
        <hr/>
        <div id="divRow2">
        ...
        <div id="divRow3">
            <a href="#">
                <span>Advertise on MusicFly.com</span>
            </a>
            <a href="#">
        ...
        <hr/>
        <p id="copyRight">© MusicFly Ltd. 2021, All Rights Reserved</p>
    </div>
</footer>`
}
